...
use AjCastro\ScribeTdd\Strategies\ResponseFields\GetFromResponseFieldTagFromScribeTdd;
...
beforeEach(function () {
    ...
    $this->strategy = new GetFromResponseFieldTagFromScribeTdd(new DocumentationConfig(config('scribe') ?? []));
});
...
it('extracts response fields from docblock when test result exists', function () {
